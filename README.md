...
# Bug 1: Select dropdown doesn't scroll with rest of the page -- completed
...
# Bug 2: Approve checkbox not working -- completed
...
# Bug 3: Cannot select _All Employees_ after selecting an employee -- completed
...
# Bug 4: Clicking on View More button not showing correct data -- completed
...
# Bug 5: Employees filter not available during loading more data -- completed
...
# Bug 6: View more button not working as expected -- completed
...
# Bug 7: Approving a transaction won't persist the new value  -- completed
